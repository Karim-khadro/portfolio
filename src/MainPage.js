import { intro, menu, profile, exp, projects, sections,contact } from './texts'; // Relative path to your File
...
export default function MainPage() {
  ...
  return (
    <div className="bg-background  text-white">
      ...
      <div className=" w-full max-w-5xl m-auto .h-screen flex flex-col space-y-5 ">
        ...
        <div id="about" className=" mb-32">
          ...
          <div className="grid grid-cols-3 gap-4 mt-5 ">
            ...
            {/* 2nd col */}
            <div className="mb-4 ">
              <img src={profile_img} className=" max-w-5/6 max-h-5/6l min-h-5/6 min-w-5/6 rounded-full border-4 border-green-300 p-2" alt="" />
            </div>
            ...
            <div className="ml-4 ">
              ...
              <ul className=''>
                ...
                <li className=' mt-6' > <span className='font-bold text-lg  opacity-50'> Age:  </span><br /> <span className=''> {calculate_age(profile.birth_date)} years </span></li>
        ...
        <div id="contact" className="border-t-2 border-main_green border-opacity-50">
          <div className='pb-2 items-center mt-16 text-center  max-w-xl m-auto '>
            <p className='leading-normal'> <h1 className=' text-2xl text-main_green tracking-wider mb-8'> 04. {sections.s4 ? sections.s4 : menu.it4}</h1></p>

            <h1 className=' text-5xl  mb-3 font-bold opacity-70 '> {contact.main_phrase} </h1>
            <p>{contact.text}</p>
      ...
      <footer className='pb-8 text-center opacity-60 mt-32 max-w-2xl m-auto'>Build & des by me <br /> 2021</footer>
    </div >
  );
